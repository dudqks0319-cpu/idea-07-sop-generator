...
import 'package:app_07_sop_generator/app.dart';
import 'package:app_07_sop_generator/services/supabase_service.dart';
...
void main() {
  testWidgets('회원가입 후 할 일을 추가하고 추천 목록에서 확인할 수 있다', (tester) async {
    ...
    expect(find.text('반복 업무 SOP 자동 생성기'), findsWidgets);
